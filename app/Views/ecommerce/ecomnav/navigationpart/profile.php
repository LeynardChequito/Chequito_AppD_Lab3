...
<?= view('ecommerce/ecomnav', ["dashboard" => "active", "dashboardPage" => "active"]); ?>
<!--==================================
=            User Profile            =
===================================-->
        ...
        <div class="sidebar">
          ...
          <div class="widget user-dashboard-profile">
            ...
            <div class="profile-thumb">
              <img src="ecommerceT/images/user/user-thumb.jpg" alt="" class="rounded-circle">
            </div>
            <!-- User Name -->
            ...
            <tbody>
              <tr>
                <td class="product-thumb">
                  <img width="80px" height="auto" src="ecommerceT/images/products/products-1.jpg" alt="image description"></td>
              ...
              <tr>
                ...
                <td class="product-thumb">
                  <img width="80px" height="auto" src="ecommerceT/images/products/products-2.jpg" alt="image description"></td>
                <td class="product-details">
              ...
              <tr>
                <td class="product-thumb">
                  <img width="80px" height="auto" src="ecommerceT/images/products/products-3.jpg" alt="image description"></td>
                <td class="product-details">
                  <h3 class="title">Macbook Pro 15inch</h3>
                  <span class="add-id"><strong>Ad ID:</strong> ng3D5hAMHPajQrM</span>
                  <span><strong>Posted on: </strong><time>Jun 27, 2017</time> </span>
