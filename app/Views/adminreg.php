...
<html lang="en">
<head>
<link rel="icon" type="image/png" href="/adminlogin/images/DB_16х16.png">
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="A front-end template that helps you build fast, modern mobile web apps.">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>GADREEL.JAEL</title>
    ...
    <!-- inject:css -->
    <link rel="stylesheet" href="<?= base_url(); ?>adminlogin/css/lib/getmdl-select.min.css">
    <link rel="stylesheet" href="<?= base_url(); ?>adminlogin/css/lib/nv.d3.min.css">
    <link rel="stylesheet" href="<?= base_url(); ?>adminlogin/css/application.min.css">
    <!-- endinject -->
